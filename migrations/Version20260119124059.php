...
final class Version20260119124059 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(
            'CREATE TABLE element_repas (id INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(255) DEFAULT NULL, quantite NUMERIC(10, 2) NOT NULL, unite VARCHAR(20) NOT NULL, calories INT NOT NULL, repas_id INT NOT NULL, recette_id INT DEFAULT NULL, INDEX IDX_6CF1252A1D236AAA (repas_id), INDEX IDX_6CF1252A89312FE9 (recette_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4'
            );
        ...
        $this->addSql('CREATE TABLE recette (id INT AUTO_INCREMENT NOT NULL, spoonacular_id INT NOT NULL, titre VARCHAR(255) NOT NULL, image_url VARCHAR(255) DEFAULT NULL, calories_par_portion INT DEFAULT NULL, protein_g NUMERIC(10, 2) DEFAULT NULL, carbs_g NUMERIC(10, 2) DEFAULT NULL, fat_g NUMERIC(10, 2) DEFAULT NULL, servings INT NOT NULL, raw_json JSON DEFAULT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_49BB639083FB1E43 (spoonacular_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE repas (id INT AUTO_INCREMENT NOT NULL, date_repas DATETIME NOT NULL, type_repas VARCHAR(20) NOT NULL, total_calories INT NOT NULL, source VARCHAR(20) NOT NULL, notes LONGTEXT DEFAULT NULL, utilisateur_id INT NOT NULL, INDEX IDX_A8D351B3FB88E14F (utilisateur_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE element_repas ADD CONSTRAINT FK_6CF1252A89312FE9 FOREIGN KEY (recette_id) REFERENCES recette (id)');
        ...
        $this->addSql('ALTER TABLE repas ADD CONSTRAINT FK_A8D351B3FB88E14F FOREIGN KEY (utilisateur_id) REFERENCES `user` (id)');
